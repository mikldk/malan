...
By standard, only the last generation contains $N$ individuals. If the 3 last generations should be full, this can be done by specifying `extra_generations_full = 2` as follows (2 extra as the last generation always has $N$ individuals, hence the last plus 2 extra are now full):
...
And to obtain the complete history, `extra_generations_full` is set to `generations-1` (as the last is always full):
